...
!!!           02/25/2021 by li huang (last modified)
...
!!
     ...
     character(len=20), public, parameter :: V_FULL_FL = 'v0.1.2 @ 2021.02.25D'
     character(len=20), public, parameter :: V_FULL_DF = 'v0.0.1 @ 2019.04.12D'
     character(len=20), public, parameter :: V_FULL_ZD = 'v0.0.1 @ 2021.02.25D'
...
!!
     ...
     character(len=06), public, parameter :: V_CURR_FL = 'v0.1.2'
     character(len=06), public, parameter :: V_CURR_DF = 'v0.0.1'
     character(len=06), public, parameter :: V_CURR_ZD = 'v0.0.1'
...
!!
     ...
     character(len=11), public, parameter :: V_DATE_FL = '2021.02.25'
     character(len=11), public, parameter :: V_DATE_DF = '2019.04.12'
     character(len=11), public, parameter :: V_DATE_ZD = '2021.02.25'
...
!!
     ...
     character(len=01), public, parameter :: V_STAT_ZD = 'D'
...
!!
     ...
     character(len=11), public, parameter :: V_AUTH_ZD = 'by li huang'
...
!!
     ...
     character(len=36), public, parameter :: V_INST_ZD = 'China Academy of Engineering Physics'
...
!!
     ...
     character(len=22), public, parameter :: V_MAIL_ZD = 'lihuang.dmft@gmail.com'
...
!!
     ...
     character(len=36), public, parameter :: V_GPL3_ZD = 'GNU General Public License version 3'
